...
import bubuImage from '../assets/bubufinal.png'
...
const EndPage = () => {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: '#ffecf2', padding: '16px', borderRadius: '8px', width: '350px', margin: '0 auto' }}>
        <motion.img initial="hidden" animate="visible" variants={variants} transition={{ duration: 0.4 }} src={bubuImage} alt="bubu kitten" className="mb-4" />
